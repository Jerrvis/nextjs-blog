...
// Exports
module.exports = {
	"article": "_slug__article__97FZ4",
	"head": "_slug__head__AlZoJ"
};
...
/* harmony import */ var _index_module_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9148);
 ...
 * @LastEditTime: 2023-03-05 15:34:10
...
async function getStaticPaths(a) {
    const list = (0,_api__WEBPACK_IMPORTED_MODULE_1__/* .getTechSlugList */ .EG)();
    return {
        paths: list.map((item)=>({
                params: {
                    slug: item
...
async function getStaticProps({ params  }) {
    const article = await (0,_api__WEBPACK_IMPORTED_MODULE_1__/* .getContentBySlug */ ._T)("tech", params.slug);
    return {
        props: {
            article
        },
...
var __webpack_exports__ = __webpack_require__.X(0, [534], () => (__webpack_exec__(3948)));
